...
<body>
  ...
  <header>
    <h1>Link Reducer</h1>
    <nav class="desktop">
      <div><a href="/ru/index.php" class="nav-link">Главная</a></div>
      <div><a href="/ru/monitoring.php" class="nav-link">Мониторинг</a></div>
    </nav>
    <div class="lang-div">
      <div class="lang-div__current-lang"><p>RU</p></div>
    ...
    <nav class="mobile">
      ...
      <div>
        <div><a href="/" class="nav-link">Главная</a></div>
        <div><a href="/" class="nav-link">Мониторинг</a></div>
      </div>
    </nav>
  </header>
  <script>
